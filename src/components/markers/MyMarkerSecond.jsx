...
const MyMarkerSecond = ({position}) => {
    return (
        <>
            ...
            <Circle center={position} radius={5000} options={closeOptions}/>
            <Circle center={position} radius={15000} options={middleOptions}/>
        </>

    );
};

export default MyMarkerSecond;